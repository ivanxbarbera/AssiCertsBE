...
const it = {
  ...
  AUTHENTICATION_USER_MALCONFIGURED: 'Utente non correttamente configurato',
  AUTHENTICATION_USER_NOT_FOUND: 'Utente non trovato',
  ...
  CUSTOMER_ADDRESS_DEFAULT_WRONG: 'Il cliente deve avere un indirizzo di default',
  CUSTOMER_EMAIL_DEFAULT_WRONG: 'Il cliente deve avere una email di default',
  CUSTOMER_PHONE_DEFAULT_WRONG: 'Il cliente deve avere un telefono di default',
  CUSTOMER_CUSTOMER_NOT_FOUND: 'Cliente non trovato',
  ...
  DEALER_EMAIL_DEFAULT_WRONG: 'Il concessionario deve avere una mail di default',
  ...
  USER_ADDRESS_PHONETYPE_NOT_FOUND: 'Tipo Telefono non trovato',
  ...
  USER_DEALER_TOO_MANY: "L'utente può avere al massimo un solo dealer",
