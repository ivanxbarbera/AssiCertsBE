...
const en = {
  ...
  CUSTOMER_ADDRESS_DEFAULT_WRONG: 'Customer must have one default address',
  CUSTOMER_EMAIL_DEFAULT_WRONG: 'Customer must have one default email',
  CUSTOMER_PHONE_DEFAULT_WRONG: 'Customer must have one default phone',
  ...
  DEALER_EMAIL_DEFAULT_WRONG: 'Dealer must have one default email',
