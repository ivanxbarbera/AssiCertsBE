INSERT INTO public."SystemParameter" ("group", "code", "name", "type", "value", "description") VALUES ('MAIL_SMTP', 'HOST', 'SMTP Host', 'TEXT', 'localhost', 'SMTP server host address');
INSERT INTO public."SystemParameter" ("group", "code", "name", "type", "value", "description") VALUES ('MAIL_SMTP', 'PORT', 'SMTP Port', 'NUMBER', '1025', 'SMTP server port');
INSERT INTO public."SystemParameter" ("group", "code", "name", "type", "value", "description") VALUES ('MAIL_SMTP', 'SECURE', 'SMTP Secure', 'BOOLEAN', 'false', 'SMTP server secure transport required');
